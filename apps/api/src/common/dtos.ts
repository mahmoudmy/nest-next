...
export class UploadDto { targetType!: string; targetId!: string; originalFilename!: string; contentType!: z.infer<typeof uploadSchema>['contentType']; size!: number; checksum!: string; static readonly schema=uploadSchema; }
